    ...
    <form action="{{ route('recipe.store') }}" method="POST" class="w-10/12 p-4 mx-auto bg-white rounded"
        ...
        <div class="grid grid-cols-2 rounded border border-gray-500 mt-4">
            <div class="col-span-1">
                <img class="object-cover w-full aspect-video" src={{ asset('images/recipe-dummy.png') }}
                    alt="recipe-image">
            ...
            <div class="col-span-1 p-4">
                ...
                <div id="ingredients">
                    ...
                    @include('components.bars-3')
                        ...
                        <p class="mx-2">:</p>
                        <input type="text" name="ingredients[{{ $i }}][quantity]" placeholder="数量" class="ingredient-quantity border border-gray-300 p-2 w-full rounded">
